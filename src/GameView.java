public class GameView {
    ...
    public void displayWinner (String name, String turtleColour){
        System.out.println ("Congratulations "+name+"!\nYour "+turtleColour+" Turtle has captured a Jewel. You hav WON!!!");
    }
    ...
    public void displayBoard (int[][] jewels, int [][] players, int max_x, int max_y){
        char [][] board = new char [max_y+1][max_x+1];
